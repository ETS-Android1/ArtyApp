...
public class TopBarActivity extends AppCompatActivity {
    ...
    public void onPost() {
        ...
        if (!TextUtils.isEmpty(title)  && postImageUri != null) {
            ...
            final StorageReference filePath = storageReference.child("ArtyPostsImages/Top").child(randomName + ".jpg");
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        try {
                            compressedImageFile = new Compressor(TopBarActivity.this)
                                    .setMaxHeight(200)
                                    .setMaxWidth(200)
                                    .setQuality(2)
                        ...
                        final StorageReference uploadThumb = storageReference.child("ArtyPostsImages/Top/thumbnails").child(randomName + ".jpg");
                        ...
                        Task<Uri> thumbUrlTask = uploadThumbnailTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    firestore.collection("Arty/Posts/Top").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                        @Override
                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(TopBarActivity.this, "Post added successfully", Toast.LENGTH_LONG).show();
                                                Intent mainIntent = new Intent(TopBarActivity.this, HomeActivity.class);
                                                startActivity(mainIntent);
                                                finish();
                                            } else {
                                                String errorMessage = task.getException().getMessage();
                                                Toast.makeText(TopBarActivity.this, "Image Error: " + errorMessage, Toast.LENGTH_LONG).show();
                                            }
                                    ...
                                    String errorMessage = task.getException().getMessage();
                                    Toast.makeText(TopBarActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    } else {
            ...
            Toast.makeText(TopBarActivity.this, "Text Fields and Image must not be empty", Toast.LENGTH_LONG).show();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toasty.info(TopBarActivity.this, error.toString(), Toast.LENGTH_LONG).show();
            }
        }
    }
