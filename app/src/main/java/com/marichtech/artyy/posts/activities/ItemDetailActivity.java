...
public class ItemDetailActivity extends AppCompatActivity {
    ...
    public void Notifications(View view) {
        startActivity(new Intent(ItemDetailActivity.this, NotificationActivity.class));
        finish();
    }
    ...
    TextWatcher productcount = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (Integer.parseInt(quantityProductPage.getText().toString()) >= 500) {
                Toasty.error(ItemDetailActivity.this, "Product Count Must be less than 500", Toast.LENGTH_LONG).show();
            }
        }
