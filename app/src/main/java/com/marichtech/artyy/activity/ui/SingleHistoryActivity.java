...
import com.marichtech.artyy.cart.OrderDetailsActivity;
...
//        }
    ...
    private void populateRecyclerView() {
        ...
        Toast.makeText(SingleHistoryActivity.this,OrderId, Toast.LENGTH_SHORT).show();
       // Toast.makeText(SingleHistoryActivity.this,userId, Toast.LENGTH_SHORT).show();

        //Say Hello to our new FirebaseUI android Element, i.e., FirebaseRecyclerAdapter
        final FirebaseRecyclerAdapter<SingleProductModel, SingleHistoryActivity.MovieViewHolder> adapter = new FirebaseRecyclerAdapter<SingleProductModel, SingleHistoryActivity.MovieViewHolder>(
                SingleProductModel.class,
                R.layout.cart_item_layout,
                SingleHistoryActivity.MovieViewHolder.class,
                //referencing the node where we want the database to store the data from our Object



                mDatabaseReference.child("orders").child(bundle.get("phone").toString()).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(bundle.get("orderId").toString()).child("items").getRef()
        ) {
            @Override
            protected void populateViewHolder(final SingleHistoryActivity.MovieViewHolder viewHolder, final SingleProductModel model, final int position) {
                ...
                Glide.with(SingleHistoryActivity.this)
                        .load(model.getPrimage_image())
                        .thumbnail(Glide.with(SingleHistoryActivity.this)
    ...
    public void viewProfile(View view) {
        startActivity(new Intent(SingleHistoryActivity.this, ProfileActivity.class));
        finish();
    }
    ...
    public void Notifications(View view) {
        ...
        startActivity(new Intent(SingleHistoryActivity.this, NotificationActivity.class));
        finish();
    }
}