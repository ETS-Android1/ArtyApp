...
public class CustomerActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    private static final int POS_WISH = 5;
    ...
    private String[] loadScreenTitles() {
        ...
        selectedTile =  getResources().getStringArray(R.array.user_activityScreenTitles);
    ...
    private Drawable[] loadScreenIcons() {
        TypedArray ta = getResources().obtainTypedArray(R.array.user_activityScreenIcons);
    ...
    public void onItemSelected(int position) {
        ...
        switch (position) {
            ...
            case POS_COLLECTION:
                slidingRootNav.closeMenu(true);
                startActivity(new Intent(this, ArtistsOrdersActivity.class));
                return;
